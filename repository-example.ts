...
export function repositoryExample():RepoReport {
  return {repository:'example / sample-project',commit:'Synthetic example — not a live scan',scanned:2,total:2,skipped:0,partial:false,inventoryComplete:true,folders:1,findingsTruncated:false,demo:true,durationMs:0,
